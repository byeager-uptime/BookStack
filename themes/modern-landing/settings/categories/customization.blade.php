            ...
            <div component="setting-homepage-control" id="homepage-control" class="grid half gap-xl items-center">
                ...
                <div>
                    <select refs="setting-homepage-control@type-control"
                        ...
                        @if(setting('modern-landing-enabled', false))
                        <option @if(setting('app-homepage-type') === 'modern-landing') selected @endif value="modern-landing">Modern Landing</option>
                        @endif
                    </select>
                    ...
                    <div class="mt-s">
                        <p class="text-small text-muted">
                            @icon('info') 
                            Modern Landing page is available. 
                            <a href="{{ url('/settings/modern-landing') }}">Configure settings</a> or 
                            <a href="{{ url('/') }}" target="_blank">preview the landing page</a>.
                        </p>
                    </div>
                    @else
                    <div class="mt-s">
                        <p class="text-small text-muted">
                            @icon('info') 
                            Want a modern landing page? 
                            <a href="{{ url('/settings/modern-landing') }}">Enable Modern Landing theme</a>.
                        </p>
                    </div>
                    @endif
                </div>
